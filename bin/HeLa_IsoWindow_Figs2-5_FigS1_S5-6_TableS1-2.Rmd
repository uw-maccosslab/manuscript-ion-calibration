...
# Plot just 500ng
figure6_supp_full_dist = ggplot(df_ratios, aes(x = Prototype, y = log2MeanRatio)) +
...
figure6_supp_full_dist


ggsave("../figures/Figure_S6.png", plot = figure6_supp_full_dist, width = 12, height = 14, dpi = 700)
