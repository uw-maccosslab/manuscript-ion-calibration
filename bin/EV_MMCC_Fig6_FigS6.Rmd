...
suppfigure6AB <- (precursorplt1 + proteinplt1) +
...
#ggsave("../ev_IDs.png", plot = suppfigure6AB, height = 5, width = 10, dpi = 700)
...
suppfig6CD <- (peptide_cv + protein_cv) + 
...
suppfig6E_ions_plot <- ggplot(df_ev_long_filtered, aes(x = Rank, y = IonCount)) +
  # Points
...
```{r, fig.width= 8, fig.height=15}
 ...
 SupplFig6_final <- (suppfigure6AB / suppfig6CD) / (suppfig6E_ions_plot) +
...
ggsave("../figures/Figure_S6_EV.png", plot = SupplFig6_final, width = 8, height = 15, dpi = 700)
